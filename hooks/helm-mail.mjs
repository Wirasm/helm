...
function howToReply(me, root) {
	return [
		...
		"ends. Nothing outside this session can be relied on to start a turn in it — a peer's",
		"socket poke is HELD rather than delivered in the permission posture helm spawns you",
		"under (#320) — but a background watch YOU arm can, because being notified is itself the",
		"wake. Without one, mail sent while you are idle waits until the operator next speaks to you.",
		...
		"  to match — measured, exit 1 and exit 124. /helm-mail-cc uses this same spelling.)",
