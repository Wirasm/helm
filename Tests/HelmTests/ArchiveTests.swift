...
final class ArchiveTests: XCTestCase {
    ...
    private func archived(
        _ name: String, cwd: String? = nil, endedAt: Double? = nil,
        agents: [Agent] = [], landed: LandedSummary? = nil
    ) -> ArchivedKild {
        ArchivedKild(
            id: name, name: name, worktree: name, agents: agents, cwd: cwd,
    ...
    func testSearchMatchesNameAndWorktree() {
