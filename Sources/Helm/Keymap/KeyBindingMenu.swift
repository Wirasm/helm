...
/// the key it mirrors, and a reloaded keymap file changes the menu with the keys. The monitor consumes the keystrokes first; these items exist for discoverability
